export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'FullStack Board',
    description: 'Learn Full-stack Course',
    type: 'public', // 'private'
    ownerIds: [], // Users list is Admin in board
    memberIds: [], // Users list is member in board
    columnOrderIds: ['column-id-01', 'column-id-02', 'column-id-03', 'column-id-04'], // Arrange the order/position of the Columns in board
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
